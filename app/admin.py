    ...
    fieldsets = (
        *UserAdmin.fieldsets,  # original form fieldsets, expanded
        (                      # new fieldset added on to the bottom
            ...
            {
                'fields': (
                    'fullname', 'organization', 'status', 'isReseller',
                ),
            },
        ),
    )
...
admin.site.register(models.LogAction)
admin.site.register(models.LogConfig)
admin.site.register(models.Log)
admin.site.register(models.Group)
admin.site.register(models.GroupFeaturePermission)
admin.site.register(models.GroupPagePermission)
admin.site.register(models.GroupViewHistoryPermission)
